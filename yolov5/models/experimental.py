...
def attempt_load(weights, device=None, inplace=True, fuse=True):
    # Fix for PosixPath pickling error on Windows
    import pathlib
    ...
    # Allow loading of external class names (used in YOLOv5-trained weights)
    torch.serialization.add_safe_globals({'models.yolo.DetectionModel': None})
